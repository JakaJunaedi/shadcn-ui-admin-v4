...
const LoginForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-orange-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 right-10 text-blue-300 animate-float animation-delay-1000">
          <Star size={28} />
        </div>
        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl font-bold text-gray-900 leading-tight">
              Transform Your
              <span className="block bg-gradient-to-r from-purple-600 via-blue-600 to-orange-500 bg-clip-text text-transparent">
                Digital Influence
              </span>
            </h2>
          ...
          <Card className="w-full max-w-md bg-white/80 backdrop-blur-sm border-white/20 shadow-xl">
            <CardHeader className="text-center space-y-4 pb-6">
              <div className="flex justify-center">
                <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-2xl flex items-center justify-center lg:hidden">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 h-12 bg-white/50 border-gray-200 focus:border-purple-500 focus:ring-purple-500/20 text-gray-900 placeholder-gray-400"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <a href="/reset-password" className="text-sm text-gray-600 hover:text-gray-700 transition-colors">
                      Forgot password?
                    </a>
                  </div>
                  <div className="relative">
